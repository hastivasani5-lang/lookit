      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-gray-900">
            Educate<span className="text-green-600">X</span>
          </h1>
        </div>
        ...
        <nav className="hidden lg:flex items-center gap-8 text-gray-700 text-sm font-medium">
          ...
          <a href="#" className="hover:text-green-600 transition">Pages</a>
          <a href="#" className="hover:text-green-600 transition">Courses</a>
        ...
        <div className="flex items-center gap-4">
          ...
          {/* LOGIN BUTTON */}
          <button className="hidden md:flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-5 py-2 rounded-full text-sm font-medium transition">
            LOGIN →
          </button>
