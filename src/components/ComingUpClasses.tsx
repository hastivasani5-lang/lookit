        ...
        <section className="my-12 bg-[#f3f4f7] py-10">
          ...
          >
            {displayCourses.map((course, idx) => (
              ...
              >
                {/* Back stack layer */}
                <div className="absolute inset-0 translate-y-2 translate-x-1 rounded-3xl bg-gray-200 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />

                {/* Left accent */}
                <div
                  className={`pointer-events-none absolute inset-y-3 -left-2 w-7 rounded-2xl bg-gradient-to-b ${course.accentClass} shadow-md opacity-0 transition-opacity duration-300 group-hover:opacity-100`}
                />
                {/* Right accent */}
                <div
                ...
                <article className="relative flex h-full flex-col rounded-3xl bg-white p-6 shadow-lg transition-all duration-300 group-hover:shadow-2xl group-hover:scale-105 group-hover:-translate-y-2">
                  {/* Save Button */}
                  <button className="absolute -top-3 -right-3 flex h-12 w-12 items-center justify-center rounded-full bg-red-600 text-white font-bold shadow-lg opacity-0 transition-opacity duration-300 group-hover:opacity-100 hover:bg-red-700">
                    ✓
                  </button>
