    ...
    <>
      ...
      <main className="min-h-screen bg-[#edf4f2] px-4 pb-14 pt-28 md:px-8 lg:px-10">
        <section className="mx-auto w-full max-w-7xl">
          <div className="relative mb-8 overflow-hidden rounded-4xl border border-[#d5e9e2] bg-white p-6 shadow-[0_22px_45px_rgba(15,23,42,0.07)] md:p-8" data-aos="fade-up">
            ...
            <div className="relative flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-3 max-w-3xl text-sm leading-7 text-gray-600 md:text-base">
                  Use the same professional-style filters to search by category, ratings,
                  reviews, language, and name.
                </p>
              </div>
